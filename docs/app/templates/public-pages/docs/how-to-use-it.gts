...
<template>
  ...
  <p>
    ...
    <em>Contextual Components</em>. If you haven't heard of it, check
    <a
      href="https://guides.emberjs.com/v2.8.0/components/wrapping-content-in-a-component/#toc_sharing-component-data-with-its-wrapped-content"
    >the official guides</a>
    for some background.
  </p>
  ...
  <p>
    ...
    receive native
    <code>Date</code>, and depending on wether you installed
    <strong>ember-power-calendar-moment</strong>
    or
    <strong>ember-power-calendar-luxon</strong>, also
    <code>moment</code>
    objects or Luxon's
    <code>DateTime</code>
  ...
  <CodeExample @glimmerTs="how-to-use-it-5.gts">
    {{HowToUseIt5}}
  </CodeExample>
  ...
  <p>
    ...
    <code>selected=someDate</code>
    to the component.
  </p>

  <CodeExample @glimmerTs="how-to-use-it-4.gts">
    {{HowToUseIt4}}
  </CodeExample>

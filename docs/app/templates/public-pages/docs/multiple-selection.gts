...
<template>
  ...
  <CodeExample @glimmerTs="multiple-selection-2.gts">
    {{MultipleSelection2}}
  </CodeExample>
  ...
  <CodeExample @glimmerTs="multiple-selection-3.gts">
    {{MultipleSelection3}}
  </CodeExample>
  ...
  <CodeExample @glimmerTs="multiple-selection-4.gts">
    {{MultipleSelection4}}
  </CodeExample>
  ...
  <div class="doc-page-nav">
    ...
    <LinkTo @route="public-pages.docs.i18n" class="doc-page-nav-link-next">I18n
      &gt;</LinkTo>
  </div>
</template>

...
export interface PowerCalendarMultipleActions {
    changeCenter?: (newCenter: Date, calendar: PowerCalendarMultipleAPI, event: Event) => TaskInstance<void>;
    moveCenter?: (step: number, unit: TPowerCalendarMoveCenterUnit, calendar: PowerCalendarMultipleAPI, event: Event) => Promise<void>;
    select?: (day: PowerCalendarDay | PowerCalendarDay[], calendar: PowerCalendarMultipleAPI, event: Event) => void;
}

...
export interface PowerCalendarActions {
    changeCenter?: (newCenter: Date, calendar: PowerCalendarAPI, event: Event) => TaskInstance<void>;
    moveCenter?: (step: number, unit: TPowerCalendarMoveCenterUnit, calendar: PowerCalendarAPI, event: Event) => Promise<void>;
    select?: (day: PowerCalendarDay, calendar: PowerCalendarAPI, event: Event) => void;
}

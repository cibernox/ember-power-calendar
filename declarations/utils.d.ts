...
import type { TCalendarType, TPowerCalendarMoveCenterUnit } from './components/power-calendar';
...
export interface BasePowerCalendarActions<T extends BaseCalendarAPI<T>> {
    changeCenter?: (newCenter: Date, calendar: T, event: MouseEvent) => TaskInstance<void>;
    moveCenter?: (step: number, unit: TPowerCalendarMoveCenterUnit, calendar: T, event: MouseEvent | KeyboardEvent) => Promise<void>;

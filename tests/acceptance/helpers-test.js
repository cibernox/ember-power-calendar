...
module('Acceptance | helpers | calendarCenter', function(hooks) {
  ...
  test('`calendarCenter` invokes the `onCenterChange` action of the target component WITH the selector we pass it', async function(assert) {
    ...
    assert.equal(find('.calendar-center-2-calendar .ember-power-calendar-nav-title').textContent.trim(), 'September 2013', 'The nav component has updated');
  ...
  test('`calendarCenter` works even if the calendar is tagless', async function(assert) {
    ...
    assert.equal(find('.calendar-center-4 .ember-power-calendar-nav-title').textContent.trim(), 'September 2013', 'The nav component has updated');

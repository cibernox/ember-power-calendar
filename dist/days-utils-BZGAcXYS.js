...
import { localeStartOfWeek, endOf, endOfWeek, startOf, startOfWeek, formatDate, normalizeCalendarDay, isSame, isBefore, isAfter } from './utils.js';
...
function focusDate(uniqueId, id, element) {
  let rootElement = document;
  if (element) {
    rootElement = element.getRootNode();
  }
  const dayElement = rootElement.querySelector(`[data-power-calendar-id="${uniqueId}"] [data-date="${id}"]`);
  if (dayElement) {
    dayElement.focus();
  }
}
...
export { DAY_IN_MS as D, lastDay as a, buildDay as b, weeks as c, focusDate as d, handleClick as e, firstDay as f, dayIsDisabled as g, handleDayKeyDown as h, localeStartOfWeekOrFallback as l, weekdaysNames as w };
//# sourceMappingURL=days-utils-BZGAcXYS.js.map

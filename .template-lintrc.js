...
const pending = [
  {
    ...
    only: ['no-invalid-interactive'],
  },
  {
    moduleId: 'tests/dummy/app/templates/helpers-testing',
    only: ['no-action', 'no-implicit-this'],
  },
  {
    moduleId: 'tests/dummy/app/templates/public-pages',
    only: ['no-curly-component-invocation', 'no-implicit-this'],
  },
  {
    moduleId:
      'tests/dummy/app/templates/components/days-grid-without-mon-or-wed',
    only: ['no-implicit-this'],
  },
  {
    moduleId: 'tests/dummy/app/templates/public-pages/cookbook',
    only: ['no-action', 'no-curly-component-invocation', 'no-implicit-this'],
  },
  {
  ...
  },
  {
    ...
    only: ['no-inline-styles', 'require-valid-alt-text'],
  },
  {
  ...
  },
  {
    ...
    only: ['no-partial', 'no-curly-component-invocation'],
  },
  {

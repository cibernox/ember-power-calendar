...
#### :rocket: Enhancement
* `ember-power-calendar`
  * [#641](https://github.com/ember-power-addons/ember-power-calendar/pull/641) Add sass/css export into package.json to support scss `pkg:` imports & update dependencies ([@mkszepp](https://github.com/mkszepp))
...
#### :bug: Bug Fix
* `ember-power-calendar`
  * [#646](https://github.com/ember-power-addons/ember-power-calendar/pull/646) Fix unwanted jumping when `autofocus = true` ([@mkszepp](https://github.com/mkszepp))
  * [#641](https://github.com/ember-power-addons/ember-power-calendar/pull/641) Add sass/css export into package.json to support scss `pkg:` imports & update dependencies ([@mkszepp](https://github.com/mkszepp))
...
#### :memo: Documentation
* `ember-power-calendar`
  * [#647](https://github.com/ember-power-addons/ember-power-calendar/pull/647) Remove v1.x examples in docs ([@mkszepp](https://github.com/mkszepp))
...
#### :house: Internal
* `ember-power-calendar`
  * [#663](https://github.com/ember-power-addons/ember-power-calendar/pull/663) Update packages ([@mkszepp](https://github.com/mkszepp))
  * [#645](https://github.com/ember-power-addons/ember-power-calendar/pull/645) Add changelog from v1.8.1 ([@mkszepp](https://github.com/mkszepp))
